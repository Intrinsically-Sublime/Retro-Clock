-----------------------
<img src=".art/banners/RetroClock_Banner.png" title="Retro Clock Title Banner" width="50%"/>
____
Turn your Ubuntu Touch device into a retro clock with a large collection of cold war era display technologies.

## Credits
----------
The code is based on Night Clock by [Michal Predotka](https://open-store.io/app/nightclock.mivoligo) and has been converted to be built with Clickable.
The program is much larger than the orginal due to all the png graphics included.
I have tried to keep it as small as possible by reducing the png resolution without sacrificing quality on a phone.
...
* Multiple presets rather than just day and night.
* Make analog clock and date/alarms display side by side in landscape.
* Option to force landscape clock while phone is in portrait.

The program could be optimized and cleaned up but I have very little experience with object oriented programming and before this program I had never used Qml, QT or Java so I have left all redundant code and even added to it.

All of the displays below are all based on real world display technology from the cold war era except the colons tubes which are fictional and generally do not exist in the real world.
picker
...
The decade counter clocks are for the tube clock lovers amung you not becasue they are good clocks.
## Options
...
* Set Foreground Color for Text, Analog Clocks and L.E.D. displays
* Adjust Hue of Nixie Tubes and other digital displays
